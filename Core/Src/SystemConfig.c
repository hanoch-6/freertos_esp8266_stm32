...
{
  esp8266_huart.Instance = USART2;
  esp8266_huart.Init.BaudRate = 115200;
  esp8266_huart.Init.WordLength = UART_WORDLENGTH_8B;
  esp8266_huart.Init.StopBits = UART_STOPBITS_1;
  esp8266_huart.Init.Parity = UART_PARITY_NONE;
  esp8266_huart.Init.Mode = UART_MODE_TX_RX;
  esp8266_huart.Init.HwFlowCtl = UART_HWCONTROL_NONE;
  esp8266_huart.Init.OverSampling = UART_OVERSAMPLING_16;
